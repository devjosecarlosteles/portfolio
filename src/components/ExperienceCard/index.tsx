...
export default function ExperienceCard({ children, companyName, position, start_date, end_date }: ExperienceCardProps) {
  return (
    <div className='w-[340px] h-[240px] mr-2 bg-green-800 rounded-md shadow-sm p-3 mb-2 inline-block bg-gradient-to-tl from-teal-900 via-emerald-800 to-green-600'>
